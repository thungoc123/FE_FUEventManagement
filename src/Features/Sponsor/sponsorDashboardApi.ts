...
export const sponsorDashboardApi = createApi({
  reducerPath: 'sponsorDashboard',
  baseQuery,
  endpoints: (builder) => ({
...
export const { useCreateSponsorMutation,useGetListSponsorProgramQuery } = sponsorDashboardApi;
