...
import { useCreateEventOperatorMutation } from "../../../Features/Admin/AdminApi";
...
export const Signup7 = (props: Signup7Props) => {
     ...
     const [createEventOperator, isLoading] = useCreateEventOperatorMutation();
     ...
     const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
          ...
          try {
               await createEventOperator(formData).unwrap();
               navigator("/");
             } catch (error) {
               console.error("Failed to create the event:", error);
               setErrors("Email has been used !");
           } 
     };
                         ...
                         <div className="container max-w-sm">
                              ...
                              <form className="grid grid-cols-1 gap-6" onSubmit={handleSubmit}>
                                   ...
                                   <div className="grid-col-1 grid gap-4">
                                        ...
                                        >
                                            {isLoading ? signUpButton.title : "Signing up ..." }
                                        </Button>
                                        {/* <Button
...
export const Signup7Defaults: Signup7Props = {
     ...
     title: "Sign Up",
     description: "Sau khi đăng ký, yêu cầu của bạn sẽ đợi Admin duyệt trong vòng 24h.",
     signUpButton: {
          title: "Sign up",
     },
     signUpWithGoogleButton: {
