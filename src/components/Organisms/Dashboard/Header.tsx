...
import { RxChevronDown, RxBell } from "react-icons/rx";
...
export const Navbar2 = (props: Navbar2Props) => {
  ...
  return (
    <nav className="flex w-full items-center border-b border-border-primary bg-background-primary lg:min-h-18 lg:px-[5%]">
      <div className="mx-auto size-full lg:grid lg:grid-cols-[0.375fr_1.375fr] lg:items-center lg:justify-between lg:gap-4">
        ...
        {/* hidden justify-self-end lg:block */}
        <div className=" hidden justify-self-end lg:block">
          ...
          <div>
            <img
              src={avatar.src}
              alt={avatar.alt}
              className="mb-4 size-10 min-h-10 min-w-10 rounded-full object-cover"
            />
          </div>
          </div>
        </div>
