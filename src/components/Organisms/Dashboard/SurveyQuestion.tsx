...
import { useCreateSurveyMutation, useGetSurveyQuestionsQuery } from "../../../Features/Survey/survey";
  // type Props = {
  ...
  export const QuestionManage = () => {
    ...
    const handleQuestionSubmit = async (e) => {
      ...
      const surveyID = Number(e.currentTarget.getAttribute('data-survey-id'));
    ...
    const tableRows: Question[] = surveyQuestions?.map((item, index) => ({
      No: index + 1,
            ...
            <Dialog>
              ...
              <DialogPortal>
                ...
                <DialogContent className="w-full max-w-md bg-white p-10 md:p-12">
                  ...
                  <form onSubmit={handleQuestionSubmit} data-survey-id={item.surveyQuestions}>
