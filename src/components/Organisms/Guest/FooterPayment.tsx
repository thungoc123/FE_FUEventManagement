...
export const Footer = (props: Footer1Props) => {
  ...
  return (
    <footer className="px-[2%] py-10 md:py-10 lg:py-2">
      <div className="container">
        <div className="grid grid-cols-1 gap-x-[8vw] gap-y-12 pb-10 md:gap-y-16 md:pb-10 lg:grid-cols-[0.75fr,1fr] lg:gap-y-4 lg:pb-2">
